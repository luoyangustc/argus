...
int  GetDefaultAccountInfo(S_Default_Account_Info*  pAccountInfo, int iAccountArraySize, int iStartIndex, int iCount, int* piTotalCount)
{
	int iRet = 0;
	FILE*   pFile = NULL;
	char  strLine[1024] = {0};
