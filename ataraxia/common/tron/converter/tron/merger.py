...
def merge_batchnorm(tron_net, copy_params):
    merged_net = Tron(tron_net.get_meta_net_name(), None)
...
def merge(tron_net, copy_params):
    merged_bn_net = merge_batchnorm(tron_net, copy_params)
