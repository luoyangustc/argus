FROM reg.qiniu.com/ava-public/ava-cuda90-cudnn7:1.0
...
# opencv 3
RUN export OPENCV_CONTRIB_ROOT=/tmp/opencv-contrib OPENCV_ROOT=/tmp/opencv OPENCV_VER=3.3.1 && \
