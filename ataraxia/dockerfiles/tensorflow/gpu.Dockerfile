...
########## INSTALLATION STEPS ###################
ENV TENSORFLOW_ROOT=/opt/tensorflow TENSORFLOW_VER=master CI_BUILD_PYTHON=python LD_LIBRARY_PATH=/usr/local/cuda/lib64:$LD_LIBRARY_PATH
ENV TF_NEED_CUDA=1 TF_CUDA_COMPUTE_CAPABILITIES=3.0,3.5,5.2,6.0,6.1 TF_CUDA_VERSION=8.0 TF_CUDNN_VERSION=6
