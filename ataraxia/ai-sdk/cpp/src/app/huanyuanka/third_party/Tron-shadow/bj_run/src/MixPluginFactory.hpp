#ifndef __MIXPLUGINFACTORY_HPP___
#define __MIXPLUGINFACTORY_HPP___
...
class MixPluginFactory : public nvinfer1::IPluginFactory, public nvcaffeparser1::IPluginFactory
{
  public:
    ...
    virtual nvinfer1::IPlugin *createPlugin(const char *layerName, const nvinfer1::Weights *weights, int nbWeights) override
    {
        ...
        {
            detection_out = std::unique_ptr<INvPlugin, void (*)(INvPlugin *)>(createSSDDetectionOutputPlugin({true, false, 0, 8, 500, 400, 0.0500000007451, 0.300000011921, CodeTypeSSD::CENTER_SIZE, {0, 1, 2}, false, true}), nvPluginDeleter);
        ...
        else if (priorboxIDs.find(std::string(layerName)) != priorboxIDs.end())
        {
            ...
            case 0:
            {
                ...
                priorboxLayers[i] = std::unique_ptr<INvPlugin, void (*)(INvPlugin *)>(createSSDPriorBoxPlugin({&minSize, &maxSize, aspectRatio, 1, 1, 2, true, false, {0.10000000149, 0.10000000149, 0.20000000298, 0.20000000298}, 0, 0, 8.0, 8.0, 0.5}), nvPluginDeleter);
                break;
            }
            case 1:
            {
                float minSize = 48.0, maxSize = 96.0, aspectRatio[] = {1.0, 2.0, 3.0};
                priorboxLayers[i] = std::unique_ptr<INvPlugin, void (*)(INvPlugin *)>(createSSDPriorBoxPlugin({&minSize, &maxSize, aspectRatio, 1, 1, 3, true, false, {0.10000000149, 0.10000000149, 0.20000000298, 0.20000000298}, 0, 0, 16.0, 16.0, 0.5}), nvPluginDeleter);
                break;
            }

            case 2:
            {
                float minSize = 96.0, maxSize = 132.0, aspectRatio[] = {1.0, 2.0, 3.0};
                priorboxLayers[i] = std::unique_ptr<INvPlugin, void (*)(INvPlugin *)>(createSSDPriorBoxPlugin({&minSize, &maxSize, aspectRatio, 1, 1, 3, true, false, {0.10000000149, 0.10000000149, 0.20000000298, 0.20000000298}, 0, 0, 32.0, 32.0, 0.5}), nvPluginDeleter);
                break;
            }

            case 3:
            {
                float minSize = 132.0, maxSize = 172.0, aspectRatio[] = {1.0, 2.0, 3.0};
                priorboxLayers[i] = std::unique_ptr<INvPlugin, void (*)(INvPlugin *)>(createSSDPriorBoxPlugin({&minSize, &maxSize, aspectRatio, 1, 1, 3, true, false, {0.10000000149, 0.10000000149, 0.20000000298, 0.20000000298}, 0, 0, 64.0, 64.0, 0.5}), nvPluginDeleter);
                break;
            }
            ...
            case 4:
            {
                ...
                priorboxLayers[i] = std::unique_ptr<INvPlugin, void (*)(INvPlugin *)>(createSSDPriorBoxPlugin({&minSize, &maxSize, aspectRatio, 1, 1, 2, true, false, {0.10000000149, 0.10000000149, 0.20000000298, 0.20000000298}, 0, 0, 100.0, 100.0, 0.5}), nvPluginDeleter);
                break;
            }
            }
    ...
    std::unique_ptr<INvPlugin, void (*)(INvPlugin *)> priorboxLayers[5]{{nullptr, nvPluginDeleter}, {nullptr, nvPluginDeleter}, {nullptr, nvPluginDeleter}, {nullptr, nvPluginDeleter}, {nullptr, nvPluginDeleter}};
