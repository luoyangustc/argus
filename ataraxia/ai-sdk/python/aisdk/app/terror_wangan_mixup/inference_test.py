...
from aisdk.app.terror_wangan_mixup.inference import InferenceServer
import aisdk.app.terror_wangan_mixup.forward as inference

from aisdk.common.download_model import parse_tsv_key, read_test_image_with_cache
from . import const

tsv_path = 'serving/terror-wangan-detect/terror-wangan-detect-201812101356/set20181210/201812101356.tsv'
tsv_prefix = 'serving/terror-wangan-detect/set20181210/'
