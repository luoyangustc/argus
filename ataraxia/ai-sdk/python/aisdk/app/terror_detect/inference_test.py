...
from aisdk.app.terror_detect.inference import InferenceServer
import aisdk.app.terror_detect.forward as inference

from aisdk.common.download_model import parse_tsv_key, read_test_image_with_cache
from . import const

tsv_path = 'serving/terror-detect/terror-detect-201811081620/set20180416/201811081620.tsv'
tsv_prefix = 'serving/terror-detect/set20180416/'
