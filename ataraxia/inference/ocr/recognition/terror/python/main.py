...
pyximport.install()
import json
from evals.src.crnn.crannrec import CrannRecModel
import cv2
import numpy as np
import base64
import config
...
from evals.utils import create_net_handler, net_preprocess_handler, net_inference_handler, CTX, monitor_rt_load, \
    monitor_rt_forward, monitor_rt_post
...
def create_net(configs):
    ...
    crann_recog = CrannRecModel(str(configs['model_files']['crann_12.pth']),
                                str(configs['model_files']['crann.yml']))
