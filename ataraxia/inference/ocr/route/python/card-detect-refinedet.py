...
item {
  ...
  label: 1
  display_name: "idcard_positive"
}
item {
  name: "idcard_negative"
  label: 2
  display_name: "idcard_negative"
}
item {
  name: "bankcard_positive"
  label: 3
  display_name: "bankcard_positive"
}
item {
  name: "bankcard_negative"
  label: 4
  display_name: "bankcard_negative"
}
item {
  name: "gongzhang"
  label: 5
  display_name: "gongzhang"
}
item {
  name: "others"
  label: 6
