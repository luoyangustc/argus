...
set(Tron_INSTALL_LIB_PREFIX lib)
...
find_package(mix REQUIRED QUIET)
include_directories(SYSTEM ${mix_INCLUDE_DIRS})
list(APPEND Tron_LINKER_LIBS ${mix_LIBRARIES})
message(STATUS "Found mix: ${mix_INCLUDE_DIRS}, ${mix_LIBRARIES}")
install(FILES ${mix_LIBRARIES} DESTINATION ${Tron_INSTALL_LIB_PREFIX})
...
if (${USE_OpenCV})
  find_package(OpenCV PATHS ${OpenCV_DIR} NO_DEFAULT_PATH QUIET COMPONENTS core highgui imgproc imgcodecs videoio cudaimgproc cudawarping)
  ...
  if (${OpenCV_VERSION} VERSION_GREATER "2.4.13")
    find_package(OpenCV REQUIRED QUIET COMPONENTS core highgui imgproc imgcodecs videoio cudaimgproc cudawarping)
  endif ()
