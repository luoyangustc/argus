...
item {
  name: "police_badge"
  label: 1
  display_name: "police_badge"
}
item {
  name: "police_car_moto"
  label: 2
  display_name: "police_car_moto"
}
item {
  name: "police_car_vehicle"
  label: 3
  display_name: "police_car_vehicle"
}
item {
  name: "police_uniform"
  label: 4
  display_name: "police_uniform"
}
"""
