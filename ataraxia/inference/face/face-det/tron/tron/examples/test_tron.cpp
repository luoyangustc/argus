...
int main(int argc, char const *argv[]) {
    ...
    std::string model_fd_file("models/refinedet_v0.0.2.tronmodel");
    std::string model_quality_file("models/quality_v0.0.1_merged.tronmodel");
    ...
    const std::string custom_params=R"({"gpu_id": 0,"use_quality": 1,"blur_threshold": 0.98,"output_pts5": 0})";
