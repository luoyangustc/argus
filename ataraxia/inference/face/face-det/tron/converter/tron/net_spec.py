...
from proto import tron_pb2


class Tron(object):
    def __init__(self, name, model_info=None, blob_shape=True):
        self.meta_net_param = tron_pb2.MetaNetParam()
    ...
    def get_meta_net_model_info(self):
        if self.meta_net_param.HasField('model_info'):
            return self.meta_net_param.model_info
        else:
            return tron_pb2.ModelInfo()
    ...
    def copy_meta_net_model_info(self, model_info):
        self.meta_net_param.model_info.CopyFrom(model_info)
