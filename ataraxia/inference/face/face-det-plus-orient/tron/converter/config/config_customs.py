...
def get_config_refinedet():
    ...
    meta_net_info = {
        ...
        'model_name': ['refinedet_v0.0.2'],  # model name on disk
        'model_epoch': [0],  # Only for mxnet model
        'save_name': 'refinedet_v0.0.2',  # Tron model save name
        'version': '0.0.2',  # model version
...
def get_config_quality_orient():
        ...
        meta_net_info = {
            'model_type': 'caffe',
            'model_name': ['quality_v0.0.2'],
            'model_epoch': [],
            'save_name': 'quality_v0.0.2',
            'version': '0.0.2',
            'method': 'quality',
            'network': [net_info]
        }
