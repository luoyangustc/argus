...
from evals.utils import value_check, file_check, parse_crop_size
...
class NetConfig(object):
    ...
    def parse(self, configs):
        '''
            parse config input
        '''
        tar_files = value_check(configs, 'tar_files')
        self.file_symbol = str(file_check(tar_files, 'deploy.symbol.json', False))
