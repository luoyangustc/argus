...
var (
	...
	ErrInvalidInterval  = httputil.NewError(http.StatusBadRequest, "invalid interval, allow interval is [0, 10]")
	...
	ErrTimeout  = httputil.NewError(499, "timeout")
)

func GenVframeCmdError(err error) error {
	switch {
