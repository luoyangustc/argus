...
import (
	...
	"qiniu.com/argus/bjob/nodes/file_scan"
...
func main() {
	...
	cconf.Init("f", "bucket-scan-master", "bucket-scan-master.conf")
	...
	var (
		...
		scan   = file_scan.NewScanNode(scanConfig)
