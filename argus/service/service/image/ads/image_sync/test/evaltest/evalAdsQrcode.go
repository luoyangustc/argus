...
func EvalAdsQrcode(EvalServer string, Server string, SceneType string) {
	var (
	...
	Describe("测试条形码、二维码tsv", func() {
		Context("测试条形码、二维码tsv", func() {
			T.TsvTest(client, tsv, T.CheckDetection)
		})
	})
	Describe("测试图片库", func() {
		Context("normal", func() {
